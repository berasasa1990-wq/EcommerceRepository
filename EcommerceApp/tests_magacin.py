...
class MagacinViewTests(TestCase):
    ...
    def test_artikli_and_detail_ok(self):
        ...
        self.assertContains(detail, 'mg-zalihe-price')
    ...
    def test_magacin_search_does_not_fill_site_search(self):
        ...
        self.assertContains(page, 'LOKACIJE I DOSTUPNO')
        self.assertContains(page, 'T-1')
    ...
    def test_order_barcode_opens_picking(self):
        ...
        self.assertEqual(stolen['Location'], reverse('staff_magacin_pakuj'))
        ...
        self.assertEqual(blocked_detail['Location'], reverse('staff_magacin_pakuj'))
